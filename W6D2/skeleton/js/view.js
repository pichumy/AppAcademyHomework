...
View.prototype.exercise1 = function () {
  ...
  const $ul = $("ul");
  $ul.children().attr("style", "background-color: orange");
  //your code here!
};
...
View.prototype.exercise3 = function () {
  ...
  const $body = $("body");
  const paragraph = $("<h1 style=\"text-align: center\"> i love jquery </h1>");
...
View.prototype.exercise4 = function () {
  ...
  $(".square:nth-child(even)").text("Dan");
  //your code here!
};
...
View.prototype.exercise5 = function () {
  ...
  $('.square').on("click", element => {
    const $square = $(element.currentTarget);
